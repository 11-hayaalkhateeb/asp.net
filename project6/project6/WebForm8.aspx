<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="project6.WebForm8" %>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-top:20px; top: -26px; left: 0px; height: 676px;" >
    <!-- Indicators -->
...
<div class="row">
  <div class="col-sm-8"  style="margin-top:-60px">
     <h1 style="color:#06283D">Together,<br/> we can bring health and hope to the world!</h1>
      <p style="margin-top:50px ;color:#06283D ; font-size:20px">Our mission is to identify, solicit, collect, <br />  sort and deliver medical services according to the urgent needs of the world.</p>

      <button class="cta">
    <span class="hover-underline-animation" style="color:#39B5E0">  GIT STARTED </span>
                            </div> 
      <div class="col-sm-4" style="margin-top:50px;"> 
         <img src="image/lan1.png"  alt="..." style="height:400px ; width:400px" />
          </div>
     </div>
    </div>
   <div class="container" >
