<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home_page.aspx.cs" Inherits="Meedical.WebForm1" %>
 ...
 .containProduct{
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/1.jpg" class="d-block w-100" alt="Wild Landscape"style="height:660px"/>
    ...
    <span class="hover-underline-animation" style="margin-bottom:2px ; text-align:center"> GIT STARTED</span>
...
<div class="text-center">
    ...
    <button class="cta" style="margin-bottom:-50px; top: 51px; left: 47px;" />
    <span class="hover-underline-animation" style="color:#39B5E0"> Beneficiary</span>

       <button class="cta" style="margin-bottom:-50px; top: 51px; left: 70px;" />
    <span class="hover-underline-animation" style="color:#39B5E0"> Donor</span>
  </div>
...
You can support it. Some medical equipment available and for more please click here ...
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                    <div class="icon-box mt-4 mt-xl-0" style="background-image:url(image/static.jpg) ; background-size:cover">
          
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0" style="background-image:url(image/chair.jpg) ; background-size:cover" >
                    <i class="bx bx-cube-alt"></i>
                    <h4 style="margin-top:-30px ; color:white"> chair </h4>
                   
                  </div>
                </div>


                   <div class="col-xl-4 d-flex align-items-stretch" style="border:2px solid white">
                     
                  <div class="icon-box mt-4 mt-xl-0" style="background-image:url(image/opacity.png) ; background-size:cover ; " >
                   
                         <p style="color:white ; margin-top:-15px ; margin-left:-70px">Aut suscipit aut cum nemo deleniti aut omnis. Doloribus ut maiores omnis facere</p>
                    <i class="bx bx-cube-alt"></i>
                    <h4 style="margin-top:-30px "> </h4>
                    <p style="color:white ; margin-top:-30px ">Aut suscipit aut cum nemo deleniti aut omnis. Doloribus ut maiores omnis facere</p>
               ...
               <%-- <div class="col-xl-4 d-flex align-items-stretch" >
                    ...
                    <h4 style="margin-top:30px;> walker </h4>
                    
                  <div class="icon-box mt-4 mt-xl-0"  style="background-image:url(image/walker.jpg) ; background-size:cover ; ">
                   <p style="color:white">Aut suscipit aut cum nemo deleniti aut omnis. Doloribus ut maiores omnis facere</p>
                  </div>
                </div>--%>
              </div>
            </div><!-- End .content-->
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="text-align:center ; margin-top:18px">Services</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="image/walker.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start">
             ...
             <div class="col-lg-6 mt-4" style="margin-left:30% ;margin-bottom:2%">
            <div class="member d-flex align-items-start">
