<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="task29.aspx.cs" Inherits="task29_12_2022.task29" %>
...
<body typeof="password">
    <form id="form1" runat="server">
       <section class="vh-100" style="background-image: url(img/about.jpg)  ; background-repeat:no-repeat ;  background-size:cover" >
